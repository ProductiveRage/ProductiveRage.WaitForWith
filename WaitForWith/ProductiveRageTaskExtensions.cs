...
namespace System.Threading.Tasks
{
    ...
    public static class ProductiveRageTaskExtensions
    {
        ...
        /// <returns>A Tuple containing the results of the Tasks, in the order in which they were specified - so long as they all completed successfully (and, if the cancellationToken parameter was given a value, before that cancellation token was set)</returns>
        ...
        /// <param name="source">The first Task to wait for</param>
        /// <param name="other">The second Task to wait for</param>
        /// <param name="timeout">A time period after which this method will cancel the Task returned by this method (though note that the individual Tasks provided will continue to run to completion, even though this method is no longer waiting for their result -
